...
enum Expression: String, CaseIterable {
    ...
    var face: Face {
        ...
        case .happy:     return .both(EyeShape(open: 1, lower: 0.5, browY: 9, browTilt: -0.08, browCurve: 0.32), pupil: 1.1)
        case .proud:     return .both(EyeShape(open: 0.8, lower: 0.58, browY: 5, browTilt: -0.14, browCurve: 0.28), pupil: 1.1)
        case .suspicious:
